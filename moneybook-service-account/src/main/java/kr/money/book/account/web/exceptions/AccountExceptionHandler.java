...
public class AccountExceptionHandler {
    ...
    public ResponseEntity<GlobalApiResponse<?>> handleAccountException(AccountException ex,
        HttpServletRequest request) {
        GlobalErrorResponse globalErrorResponse = GlobalErrorResponse.of(ex.getErrorCode(),
