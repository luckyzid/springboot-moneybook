...
@Table(name = "mb_budget_category")
public class BudgetCategoryAnalyze extends MutableBaseEntity {
    ...
    @Builder
    public BudgetCategoryAnalyze(Long idx, String userKey, Long accountIdx, Long categoryIdx, LocalDate transactionDate,
