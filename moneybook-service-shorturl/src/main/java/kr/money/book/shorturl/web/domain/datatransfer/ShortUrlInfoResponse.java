...
@Schema(description = "단축 URL 생성 응답")
@Builder(toBuilder = true)
public record ShortUrlInfoResponse(
    ...
    public static ShortUrlInfoResponse of(ShortUrlInfo shortUrlInfo) {

        return ShortUrlInfoResponse.builder()
